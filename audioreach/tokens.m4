# Copyright, Linaro Ltd, 2023,2025
...
`	AR_TKN_U32_CONTROL_LINK_IID "50"'
`	AR_TKN_U32_CONTROL_LINK_PEER1_MOD_IID "51"'
`	AR_TKN_U32_CONTROL_LINK_PEER1_MOD_PORT_ID "52"'
`	AR_TKN_U32_CONTROL_LINK_PEER2_MOD_IID "53"'
`	AR_TKN_U32_CONTROL_LINK_PEER2_MOD_PORT_ID "54"'
`	AR_TKN_U32_CONTROL_LINK_INTENT0 "55"'
`	AR_TKN_U32_CONTROL_LINK_INTENT1 "56"'
`	AR_TKN_U32_CONTROL_LINK_INTENT2 "57"'
`	AR_TKN_U32_CONTROL_LINK_INTENT3 "58"'
