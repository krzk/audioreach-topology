...
`                "NAME_PREFIX.sp$1, , NAME_PREFIX.mfc$1"'
`                "NAME_PREFIX.codec_dma_rx$1, , NAME_PREFIX.sp$1"'
...
AR_MODULE_SP(MOD_INDEX, SG_INDEX, CONTAINER_INDEX,   SP_MODULE_IID, 1, 1, 2, 1, 1, 2, CDC_DMA_MODULE_IID)
