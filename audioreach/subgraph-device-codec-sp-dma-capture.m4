...
include(`audioreach/module_speaker_protection.m4') dnl
...
AR_MODULE_LOG(MOD_INDEX, SG_INDEX, CONTAINER_INDEX, LOG_MODULE_IID, 1, 1, 2, 1, 1, 2, 0x000019ab, 1, 0, SP_MODULE_IID)
AR_MODULE_SP(MOD_INDEX, SG_INDEX, CONTAINER_INDEX, SP_MODULE_IID, 1, 1, 2, 1, 1, 2, NONE_IID)
dnl kcontrol switch
